...
def clear_config():
    from CTFByte.utils import _get_config, get_app_config
...
def clear_standings():
    from CTFByte.models import Users, Teams  # noqa: I001
    from CTFByte.constants.static import CacheKeys
    from CTFByte.utils.scores import get_standings, get_team_standings, get_user_standings
    from CTFByte.api.v1.scoreboard import ScoreboardDetail, ScoreboardList
...
def clear_challenges():
    from CTFByte.utils.challenges import get_all_challenges  # noqa: I001
    from CTFByte.utils.challenges import get_solves_for_challenge_id
    from CTFByte.utils.challenges import get_solve_ids_for_user_id
    from CTFByte.utils.challenges import get_solve_counts_for_challenges
...
def clear_pages():
    from CTFByte.utils.config.pages import get_page, get_pages
...
def clear_user_recent_ips(user_id):
    from CTFByte.utils.user import get_user_recent_ips

    cache.delete_memoized(get_user_recent_ips, user_id=user_id)


def clear_user_session(user_id):
    from CTFByte.utils.user import (  # noqa: I001
        get_user_attrs,
        get_user_place,
        get_user_score,
        get_user_recent_ips,
...
def clear_team_session(team_id):
    from CTFByte.utils.user import get_team_attrs, get_team_place, get_team_score
