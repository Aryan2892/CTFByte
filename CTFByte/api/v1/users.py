...
from CTFByte.cache import clear_challenges, clear_standings, clear_user_session
...
from CTFByte.schemas.awards import AwardSchema
from CTFByte.schemas.submissions import SubmissionSchema
from CTFByte.schemas.users import UserSchema
from CTFByte.utils.config import get_mail_provider
from CTFByte.utils.decorators import admins_only, authed_only, ratelimit
from CTFByte.utils.decorators.visibility import (
    check_account_visibility,
    check_score_visibility,
)
from CTFByte.utils.email import sendmail, user_created_notification
from CTFByte.utils.helpers.models import build_model_filters
from CTFByte.utils.security.auth import update_user
from CTFByte.utils.user import get_current_user, get_current_user_type, is_admin
...
class UserPublic(Resource):
    ...
    def patch(self, user_id):
        ...
        # https://github.com/CTFByte/CTFByte/issues/1794
        response = schema.dump(response.data)
        db.session.commit()
        db.session.close()
