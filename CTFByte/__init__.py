...
import CTFByte.utils.config
from CTFByte import utils
from CTFByte.constants.themes import ADMIN_THEME, DEFAULT_THEME
from CTFByte.plugins import init_plugins
from CTFByte.utils.crypto import sha256
from CTFByte.utils.initialization import (
    init_events,
    init_logs,
...
from CTFByte.utils.migrations import create_database, migrations, stamp_latest_revision
from CTFByte.utils.sessions import CachingSessionInterface
...
def confirm_upgrade():
    if sys.stdin.isatty():
        print("/*\\ CTFByte has updated and must update the database! /*\\")
...
def create_app(config="CTFByte.config.Config"):
    ...
    with app.app_context():
        ...
        for theme_name in CTFByte.utils.config.get_themes():
        ...
        from CTFByte.models import (  # noqa: F401
            Challenges,
            Fails,
            Files,
            Flags,
        ...
        # Upgrading from an older version of CTFByte
        ...
        from CTFByte.api import api
        from CTFByte.auth import auth
        from CTFByte.challenges import challenges
        from CTFByte.errors import render_error
        from CTFByte.events import events
        from CTFByte.scoreboard import scoreboard
        from CTFByte.teams import teams
        from CTFByte.users import users
        from CTFByte.views import views
