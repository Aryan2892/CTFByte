...
class Notifications(db.Model):
    ...
    @property
    def html(self):
        from CTFByte.utils.config.pages import build_markdown
        from CTFByte.utils.helpers import markup
...
class Pages(db.Model):
    ...
    @property
    def html(self):
        from CTFByte.utils.config.pages import build_html, build_markdown
...
class Awards(db.Model):
    ...
    @hybrid_property
    def account_id(self):
        from CTFByte.utils import get_config
...
class Users(db.Model):
    ...
    def validate_password(self, key, plaintext):
        from CTFByte.utils.crypto import hash_password
    ...
    def get_place(self, admin=False, numeric=False):
        """
        This method is generally a clone of CTFByte.scoreboard.get_standings.
        The point being that models.py must be self-reliant and have little
        to no imports within the CTFByte application as importing from the
        application itself will result in a circular import.
        """
        from CTFByte.utils.scores import get_user_standings  # noqa: I001
        from CTFByte.utils.humanize.numbers import ordinalize
...
class Teams(db.Model):
    ...
    def get_invite_code(self):
        ...
        from CTFByte.utils.security.signing import serialize, hmac
    ...
    def load_invite_code(cls, code):
        ...
        from CTFByte.exceptions import TeamTokenExpiredException, TeamTokenInvalidException
    ...
    def get_place(self, admin=False, numeric=False):
        ...
        application itself will result in a circular import.
        """
        from CTFByte.utils.scores import get_team_standings  # noqa: I001
        from CTFByte.utils.humanize.numbers import ordinalize
