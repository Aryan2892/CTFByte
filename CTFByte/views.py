...
from CTFByte.constants.config import (
...
from CTFByte.utils import config, get_config, set_config
from CTFByte.utils import user as current_user
from CTFByte.utils import validators
from CTFByte.utils.config import is_setup, is_teams_mode
from CTFByte.utils.config.pages import build_markdown, get_page
from CTFByte.utils.config.visibility import challenges_visible
from CTFByte.utils.dates import ctf_ended, ctftime, view_after_ctf
from CTFByte.utils.decorators import authed_only
...
from CTFByte.utils.health import check_config, check_database
from CTFByte.utils.helpers import get_errors, get_infos, markup
from CTFByte.utils.modes import USERS_MODE
from CTFByte.utils.security.auth import login_user
from CTFByte.utils.security.csrf import generate_nonce
from CTFByte.utils.security.signing import (
    BadSignature,
    BadTimeSignature,
    SignatureExpired,
    serialize,
...
from CTFByte.utils.uploads import get_uploader, upload_file
from CTFByte.utils.user import authed, get_current_team, get_current_user, is_admin
...
def themes_beta(theme, path):
    ...
    In CTFByte 4.0 this url_for behavior and this themes_beta
