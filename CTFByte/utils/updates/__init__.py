...
from CTFByte.models import Challenges, Teams, Users, db
from CTFByte.utils import get_app_config, get_config, set_config
from CTFByte.utils.config import is_setup
from CTFByte.utils.crypto import sha256


def update_check(force=False):
    """
    Makes a request to ctfd.io to check if there is a new version of CTFByte available. The service is provided in return
