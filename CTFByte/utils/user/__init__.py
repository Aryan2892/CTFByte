...
from CTFByte.constants.teams import TeamAttrs
from CTFByte.constants.users import UserAttrs
from CTFByte.models import Fails, Teams, Tracking, Users, db
from CTFByte.utils import get_config
from CTFByte.utils.security.auth import logout_user
from CTFByte.utils.security.signing import hmac
...
def get_ip(req=None):
    """ Returns the IP address of the currently in scope request. The approach is to define a list of trusted proxies
     ...
     CTFByte does not use IP address for anything besides cursory tracking of teams and it is ill-advised to do much
