...
from CTFByte.cache import clear_user_recent_ips
from CTFByte.exceptions import UserNotFoundException, UserTokenExpiredException
from CTFByte.models import Tracking, db
from CTFByte.utils import config, get_config, import_in_progress, markdown
from CTFByte.utils.config import (
    can_send_mail,
    ctf_logo,
    ctf_name,
    ctf_theme,
...
from CTFByte.utils.config.pages import get_pages
from CTFByte.utils.dates import isoformat, unix_time, unix_time_millis
from CTFByte.utils.events import EventManager, RedisEventManager
from CTFByte.utils.humanize.words import pluralize
from CTFByte.utils.modes import generate_account_url, get_mode_as_word
from CTFByte.utils.plugins import (
...
from CTFByte.utils.security.auth import login_user, logout_user, lookup_user_token
from CTFByte.utils.security.csrf import generate_nonce
from CTFByte.utils.user import (
    authed,
...
def init_template_globals(app):
    from CTFByte.constants import JINJA_ENUMS  # noqa: I001
    from CTFByte.constants.assets import Assets
    from CTFByte.constants.config import Configs
    from CTFByte.constants.plugins import Plugins
    from CTFByte.constants.sessions import Session
    from CTFByte.constants.static import Static
    from CTFByte.constants.users import User
    from CTFByte.constants.teams import Team
    from CTFByte.forms import Forms
    from CTFByte.utils.config.visibility import (
        accounts_visible,
        challenges_visible,
        registration_visible,
        scores_visible,
    )
    from CTFByte.utils.countries import get_countries, lookup_country_code
    from CTFByte.utils.countries.geoip import lookup_ip_address, lookup_ip_address_city
