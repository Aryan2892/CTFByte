...
function mlcSetup(_event) {
  let params = {
    ...
    event_url: window.location.origin + CTFByte.config.urlRoot,
    redirect_url: window.location.origin + CTFByte.config.urlRoot + "/redirect",
    integration_setup_url:
      window.location.origin + CTFByte.config.urlRoot + "/setup/integrations",
