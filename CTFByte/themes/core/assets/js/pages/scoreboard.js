...
const updateScores = () => {
  CTFByte.api.get_scoreboard_list().then(response => {
...
const buildGraphData = () => {
  return CTFByte.api.get_scoreboard_detail({ count: 10 }).then(response => {
    ...
    const option = {
      title: {
        left: "center",
        text: "Top 10 " + (CTFByte.config.userMode === "teams" ? "Teams" : "Users")
      },
      tooltip: {
        trigger: "axis",
        axisPointer: {
